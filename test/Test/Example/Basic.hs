...
example0 =
  testGroup "Example 0"
    [ testProperty "success" prop_success
    , testProperty "discard" prop_discard
    , testProperty "failure" prop_failure
    ]
...
example1 =
  testGroup "Example 1"
    [ testProperty "test limit" prop_test_limit
    , testProperty "discard limit" prop_discard_limit
    , testProperty "shrink limit" prop_shrink_limit
    ]
...
example4 =
  testGroup "Example 4"
    [ testProperty "hutton 1" prop_hutton_1
    , testProperty "hutton 2" prop_hutton_2
    ]
...
example5 =
  testGroup "Example 5"
    [ testProperty "record" prop_record
    ]
